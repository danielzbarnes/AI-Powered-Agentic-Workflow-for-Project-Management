...
class DirectPromptAgent:
    ...
    def respond(self, prompt):
        ...
        client = OpenAI(api_key=self.openai_api_key, base_url=os.getenv("BASE_URL"))
    ...
    def evaluate(self, initial_prompt):
        ...
        for i in range(self.max_interactions): # TODO: 2 - Set loop to iterate up to the maximum number of interactions:
            ...
            response = client.chat.completions.create(
                model="gpt-3.5-turbo",
                messages=[
                    {"role": "system", "content": f"You are {self.persona}, an evaluation agent. Forget all previous context."},
            ...
            if evaluation.lower().startswith("yes"):
                ...
                response = client.chat.completions.create(
                    model="gpt-3.5-turbo",
                    messages=[
                        {"role": "system", "content": f"You are {self.persona}, an instruction agent. Forget all previous context."},
        ...
        return {
            self.worker_agent.respond(initial_prompt): response_from_worker,
...
class RoutingAgent():
    ...
    # TODO: 3 - Define a method to route user prompts to the appropriate agent
        ...
        for agent in self.agents:
            agent_emb = self.get_embedding(agent.get("description",""))
