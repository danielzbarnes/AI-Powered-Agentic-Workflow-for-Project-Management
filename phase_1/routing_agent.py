...
routing_response_1 = routing_agent.route("Tell me about the history of Rome, Texas")
print("Routing Agent Response to Prompt 1:", routing_response_1)

routing_response_2 = routing_agent.route("Tell me about the history of Rome, Italy")
print("Routing Agent Response to Prompt 2:", routing_response_2)

routing_response_3 = routing_agent.route("One story takes 2 days, and there are 20 stories")
print("Routing Agent Response to Prompt 3:", routing_response_3)